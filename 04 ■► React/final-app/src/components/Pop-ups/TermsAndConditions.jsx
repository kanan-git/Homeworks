    ...
    return (
        <>
            ...
            <div className={s.termsandconditions}>
                ...
                <h3 className={s.termsandconditions__headers}></h3> Registration
                ...
                <h3 className={s.termsandconditions__headers}></h3> Use of Services
                ...
                <h3 className={s.termsandconditions__headers}></h3> Payment and Shipping
                ...
                <h3 className={s.termsandconditions__headers}></h3> Returns and Refunds
                ...
                <h3 className={s.termsandconditions__headers}></h3> Disclaimer of Warranties
                ...
                <h3 className={s.termsandconditions__headers}></h3> Limitation of Liability
                ...
                <h3 className={s.termsandconditions__headers}></h3> Changes to Terms
